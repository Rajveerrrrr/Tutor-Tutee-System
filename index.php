        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="title" style="font-size: large; text-align: center;">Result</div>
            </div>
            <!--/.info-box-->
          </div>
          </a> 
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box brown-bg">
              ...
              <div class="title" style="font-size: large; text-align: center;">Attendance</div>
            </div>
            <!--/.info-box-->
          </div>
          </a>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              ...
              <div class="title" style="font-size: large; text-align: center;">Basic Information</div>
            </div>
            <!--/.info-box-->
          </div>
        </a>
          <!--/.col-->
          <a href="parentsmeet.php">
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box green-bg">
              <!-- <i class="fa fa-cubes"></i> -->
              <!-- <div class="count">1.426</div> -->
              <div class="title" style="font-size: large; text-align: center;">Tutor Parents Information</div>
            </div>
            <!--/.info-box-->
          </div>
          </a>
          <!--/.col-->
          <a href="skillEnhancement.php">
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box yellow-bg">
              <!-- <i class="fa fa-thumbs-o-up"></i> -->
              <!-- <div class="count">4.362</div> -->
              <div class="title" style="font-size: large; text-align: center;">Skills Enhancement</div>
            </div>
            <!--/.info-box-->
          </div>
          </a>
          <!--/.col-->
          <a href="tutor_tutee_meet.php">
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box purple-bg">
              <!-- <i class="fa fa-cloud-download"></i> -->
              <!-- <div class="count">6.674</div> -->
              <div class="title" style="font-size: large; text-align: center;">Tutor Tutee Meet</div>
            </div>
            <!--/.info-box-->
          </div>
          </a> 
