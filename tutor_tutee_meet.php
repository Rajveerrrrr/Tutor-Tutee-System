...
<?php
  ...
  $query = "select * from tutor_tutee_meet";
  ...
  if(isset($_POST['submit']))
  {
    ...
    $SQL = "INSERT INTO tutor_tutee_meet (tutor_meet_id  ,student_name, d_t , remarks ) VALUES ('', '$student_name', $d_t' ,'$remarks')";
...
if (isset($_POST['id'])) {
  ...
  $stmt = $conn->prepare("DELETE FROM tutor_tutee_meet WHERE tutor_meet_id = ?");
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i>TUTOR TUTEE MEET</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-laptop"></i>Tutor Tutee Meet</li>
            </ol>
          </div>
        </div>
              ...
              <div class="modal-body" style="padding:40px 50px;">
                <form role="form" method="post">
                  <div class="form-group">
                    <label for="usrname"><span class="glyphicon glyphicon-user"></span>Tutor Group</label>
                    <label for="usrname"><span class="glyphicon glyphicon-user">6A3</span></label>
                ...
                <tbody>
                  ...
                  <tr>
                    <?php 
                      ...
                      {
                   ?>
                   <td><?php echo $row['tutor_meet_id']; ?></td>
        ...
        <a class="btn btn-danger" href="#" onclick="deleteMeeting(<?php echo $row['tutor_meet_id']; ?>);">
